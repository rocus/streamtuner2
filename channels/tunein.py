...
# url: http://tunein.com/
# config:
#   { name: radiotime_group, value: music, type: select, select: music|genres|podcast, description: Catalogue type as categories. (→ Reload Category Tree) }
